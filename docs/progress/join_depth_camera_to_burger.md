...
https://github.com/user-attachments/assets/6c2ecfc2-dbb0-4788-b89d-950f6b7a8b7a
...
현재 프로젝트에서는 depth camera를 사용한 3d-slam이 필요하기 때문에 기존 2d-slam에서 사용했던 cartographer를 사용하기 힘들어짐.

따라서 **RTAB-Map**를 사용하여 3d-slam을 진행해야 함.