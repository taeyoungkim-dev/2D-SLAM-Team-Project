...
Tip: RViz2 창이 열리면 왼쪽 하단 Add 버튼을 눌러 By topic 탭에서 /camera/image_raw를 추가하면 로봇의 1인칭 카메라 뷰를 실시간으로 확인할 수 있습니다.
...
맵 스캔이 충분히 완료되었다면, 새로운 터미널을 열고 생성된 지도를 저장합니다. (map이라는 이름의 .yaml과 .pgm 파일이 생성됩니다.)
